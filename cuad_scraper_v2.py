...
CLUBS = [
    ...
    ("AZINE Asian / American Arts & Zine Collective",                  "azine.collective",          "private"),
    ...
    ("GSAS Queer Graduate Collective",                                 "queergradcollective",       "private"),
    ...
    ("Sexual and Reproductive Health Action Group (Mailman)",          "shag_at_mailman",           "maybe_removed"),
    ...
    ("CLS Human Rights Association",                                   "clshumanrights",            "private"),
